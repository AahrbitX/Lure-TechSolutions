        ...
        <form className="flex flex-col gap-6 mt-6">
          ...
          <div className="flex flex-col p-2">
            ...
            <input
              ...
              className="border-b-2 bg-black  border-white p-2 focus:border-cgreen border-0 outline-none"
            />
          </div>
          {/* Phone Number Field */}
          <div className="flex flex-col p-2">
            ...
            <input
              ...
              className="border-b-2  bg-black  border-white border-cblack p-2 focus:border-cgreen border-0 outline-none"
            />
          </div>
